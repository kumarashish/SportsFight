...
public class ColorfulRingProgressView extends View {
    ...
    private int drawFirst = 0, drawSecond = 0, drawThird = 0, drawFourth = 0, drawFifth = 0, drawSixth = 0, drawSeventh = 0, drawEighth = 0;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawSecond == 1) {
            canvas.drawArc(mOval, 315, mPercent * 3.6f, false, mPaint);
        }

        if (drawThird == 1) {
            canvas.drawArc(mOval, 360, mPercent * 3.6f, false, mPaint);
        }

        if (drawFourth == 1) {
            canvas.drawArc(mOval, 405, mPercent * 3.6f, false, mPaint);
        }

        if (drawFifth == 1) {
            canvas.drawArc(mOval, 450, mPercent * 3.6f, false, mPaint);
        }

        if (drawSixth == 1) {
            canvas.drawArc(mOval, 495, mPercent * 3.6f, false, mPaint);
        }

        if (drawSeventh == 1) {
            canvas.drawArc(mOval, 540, mPercent * 3.6f, false, mPaint);
        }

        if (drawEighth == 1) {
            canvas.drawArc(mOval, 585, mPercent * 3.6f, false, mPaint);
        }

        //canvas.drawArc(mOval, mStartAngle+100, mPercent * 3.6f, false, mPaint);
    }
    ...
    public int getDrawFirst() {
        return drawFirst;
    }

    public void setDrawFirst(int drawFirst) {
    ...
    public int getDrawThird() {
        return drawThird;
    }

    public void setDrawThird(int drawThird) {
        this.drawThird = drawThird;
        refreshTheLayout();
    }

    public int getDrawFourth() {
        return drawFourth;
    }

    public void setDrawFourth(int drawFourth) {
        this.drawFourth = drawFourth;
        refreshTheLayout();
    }

    public int getDrawFifth() {
        return drawFifth;
    }

    public void setDrawFifth(int drawFifth) {
        this.drawFifth = drawFifth;
        refreshTheLayout();
    }

    public int getDrawSixth() {
        return drawSixth;
    }

    public void setDrawSixth(int drawSixth) {
        this.drawSixth = drawSixth;
        refreshTheLayout();
    }

    public int getDrawSeventh() {
        return drawSeventh;
    }

    public void setDrawSeventh(int drawSeventh) {
        this.drawSeventh = drawSeventh;
        refreshTheLayout();
    }

    public int getDrawEighth() {
        return drawEighth;
    }

    public void setDrawEighth(int drawEighth) {
        this.drawEighth = drawEighth;
        refreshTheLayout();
    }
}
